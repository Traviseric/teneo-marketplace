...
python "C:/code/orchestrator/src/orchestrator/tools/creds_swap.py" swap --lane-id "worker_001"
...
claude --dangerously-skip-permissions --model sonnet 2>"C:\\code\\openbazaar-ai\\.overnight\\worker_001_managed_stderr.log"
...
if exist "C:\\code\\openbazaar-ai\\.overnight\\worker_001_managed_stderr.log" (
    findstr /i /c:"hit your limit" /c:"rate-limit" /c:"resets" "C:\\code\\openbazaar-ai\\.overnight\\worker_001_managed_stderr.log" >nul 2>&1
    if not errorlevel 1 (
        echo MANAGED WORKER RATE LIMITED - see C:\\code\\openbazaar-ai\\.overnight\\worker_001_managed_stderr.log
    )
)
