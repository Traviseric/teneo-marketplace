...
python "C:/code/orchestrator/src/orchestrator/tools/creds_swap.py" swap --token "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" --lane-id "worker_001"
...
claude --dangerously-skip-permissions --model sonnet 2>"C:\\code\\teneo-marketplace\\.overnight\\worker_001_managed_stderr.log"
...
if exist "C:\\code\\teneo-marketplace\\.overnight\\worker_001_managed_stderr.log" (
    findstr /i /c:"hit your limit" /c:"rate-limit" /c:"resets" "C:\\code\\teneo-marketplace\\.overnight\\worker_001_managed_stderr.log" >nul 2>&1
    if not errorlevel 1 (
        echo MANAGED WORKER RATE LIMITED - see C:\\code\\teneo-marketplace\\.overnight\\worker_001_managed_stderr.log
    )
)
