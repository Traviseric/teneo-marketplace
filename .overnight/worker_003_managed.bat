...
python "C:/code/orchestrator/src/orchestrator/tools/creds_swap.py" swap --token "sk-ant-oat01-REDACTED" --lane-id "worker_003"
...
claude --dangerously-skip-permissions --model sonnet 2>"C:\\code\\openbazaar-ai\\.overnight\\worker_003_managed_stderr.log"
...
if exist "C:\\code\\openbazaar-ai\\.overnight\\worker_003_managed_stderr.log" (
    findstr /i /c:"hit your limit" /c:"rate-limit" /c:"resets" "C:\\code\\openbazaar-ai\\.overnight\\worker_003_managed_stderr.log" >nul 2>&1
    if not errorlevel 1 (
        echo MANAGED WORKER RATE LIMITED - see C:\\code\\openbazaar-ai\\.overnight\\worker_003_managed_stderr.log
    )
)
